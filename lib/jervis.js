...
export function jervisReservationPayload(booking, config = {}) {
  ...
  // Deliberately no phone: when Jervis receives a guest phone it sets the
  // door pincode to the last 4 digits of it, which guests can guess.
  // Without a phone Jervis generates a random pincode instead.
  return {
