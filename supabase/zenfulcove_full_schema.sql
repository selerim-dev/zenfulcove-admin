...
-- ============================================================================
-- Source: supabase/sql/0014_stripe_checkout_hardening.sql
-- ============================================================================
...
-- ============================================================================
-- Source: supabase/sql/0017_kayak_stripe_products.sql
-- ============================================================================
...
-- ===========================================================================
-- In-Cabin Massage ("Elevate Your Stay") — see 0019_spa_massage.sql
-- ===========================================================================
create extension if not exists "btree_gist";
...
do $$ begin
  create type public.massage_booking_status as enum (
    'pending_payment','pending_therapist','confirmed','declined','expired','cancelled','completed'
  );
